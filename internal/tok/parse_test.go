	...
	var tests = []struct {
		...
		},
		{
			...
			[]Token{
				...
				LeftParen{position{start: 10, end: 10, line: 1, column: 11}},
				...
				RightParen{position{start: 17, end: 17, line: 1, column: 18}},
		...
		},
		{
			...
			[]Token{
				...
				Ass{position{start: 17, end: 17, line: 1, column: 18}},
				LeftBracket{position{start: 19, end: 19, line: 1, column: 20}},
				...
				RightBracket{position{start: 28, end: 28, line: 1, column: 29}},
		...
		},
		{
			...
			[]Token{
				...
				LeftShift{position{start: 15, end: 16, line: 1, column: 16}},
		...
		},
		{
			...
			[]Token{
				Ident{position{start: 0, end: 0, line: 1, column: 1}},
				LeftBracket{position{start: 2, end: 2, line: 1, column: 3}},
				...
				RightBracket{position{start: 10, end: 10, line: 1, column: 11}},
