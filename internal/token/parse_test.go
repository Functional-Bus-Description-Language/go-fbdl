	...
	var tests = []struct {
		...
		},
		{
			...
			[]Token{
				...
				Indent{start: 14, end: 14, line: 2, column: 1},
		...
		},
		{
			...
			[]Token{
				...
				Indent{start: 30, end: 31, line: 4, column: 1},
				...
				Dedent{start: 42, end: 42, line: 5, column: 1},
